...
bars1 = ax1.bar(index + 1.5 * bar_width, F_1st, bar_width, color=set_color(0,'f',0,False), label='F w/o Head+CE')
bars2 = ax1.bar(index + 2.5 * bar_width, F_last, bar_width, color=set_color(0,'f',0,False), label='F w/ Head+CE', edgecolor="black", hatch='//')
bars3 = ax1.bar(index + 3.5 * bar_width, B_1st, bar_width, color=set_color(0,'b',0,False), label='B w/o Head+CE')
bars4 = ax1.bar(index + 4.5 * bar_width, B_last, bar_width, color=set_color(0,'b',0,False), label='B w/ Head+CE', edgecolor="black", hatch='\\\\')
...
bars1_hidden = ax2.bar(index_hidden + 1.5 * bar_width, F_1st_hidden, bar_width, color=set_color(0,'f',0,False), label='F w/o Head+CE')
bars2_hidden = ax2.bar(index_hidden + 2.5 * bar_width, F_last_hidden, bar_width, color=set_color(0,'f',0,False), label='F w/ Head+CE', edgecolor="black", hatch='//')
bars3_hidden = ax2.bar(index_hidden + 3.5 * bar_width, B_1st_hidden, bar_width, color=set_color(0,'b',0,False), label='B w/o Head+CE')
bars4_hidden = ax2.bar(index_hidden + 4.5 * bar_width, B_last_hidden, bar_width, color=set_color(0,'b',0,False), label='B w/ Head+CE', edgecolor="black", hatch='\\\\')
