...
global_context = Config.from_file("/home/PJLAB/matenghui/work/PipelineSimulator/simulator/config.py")

if __name__ == "__main__":
    c = Config()
    c = Config.from_file("/home/PJLAB/matenghui/work/PipelineSimulator/simulator/config.py")
    print(c)
    c['K'] = 1
    print(c["K"])