...
MAX_ACTIVATION_TIMES_OF_STAGE_NUM = 2

STAGE_SEARCH_METHOD = StageSearchOrder.Random
EMBEDDING_TIME = 1
LAST_FFN_F_TIME = 6
LAST_FFN_B_TIME = LAST_FFN_F_TIME * 2
LOSS_F_TIME = 3
LOSS_B_TIME = LOSS_F_TIME * 2
...
SPLIT_BACKPROP = True
SCHEDULE_METHOD = SchedulePriority.GREEDY_v2
...
RECOMPUTEING_METHOD = RecomputeType.FULL
F_ACTIVATION_RATE = 0.03
B_ACTIVATION_RATE = 1 if SPLIT_BACKPROP else -1
W_ACTIVATION_RATE = -1 if SPLIT_BACKPROP else 0
